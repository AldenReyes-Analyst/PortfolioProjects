# 📊 Alden Reyes | Data Analytics Portfolio

👋 **Hi, I'm Alden!** I am an Information Technology graduate and aspiring **Junior Data Analyst**. I specialize in transforming raw, unstructured datasets into actionable business insights using **SQL Server, Microsoft Excel, and Tableau**. 

This portfolio showcases my end-to-end analytical workflow—including data cleaning, query optimization, exploratory data analysis (EDA), and interactive dashboard design. I am actively seeking a **Junior Data Analyst / Data Analyst** role where I can help teams make data-driven decisions.
